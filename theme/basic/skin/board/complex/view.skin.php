...
;
    ...
    <section id="bo_v_atc">
        ...
        <p>지정면적 : <?php echo get_view_thumbnail($view['wr_3']); ?>
        <p>사업기간(년) : <?php echo get_view_thumbnail($view['wr_4']); ?>
        <p>총사업비(억원) : <?php echo get_view_thumbnail($view['wr_5']); ?>
        <p>사업시행자 : <?php echo get_view_thumbnail($view['wr_6']); ?>
        <p>공정율(%) : <?php echo get_view_thumbnail($view['wr_7']); ?>
        <p>산업용지평균 분양가(원/m²) : <?php echo get_view_thumbnail($view['wr_8']); ?>
        </p>
