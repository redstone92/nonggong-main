...
;
    ...
    <section id="bo_v_atc">
        ...
        <p>직책 : <?php echo get_view_thumbnail($view['wr_2']); ?>
        <p>이름 : <?php echo get_view_thumbnail($view['subject']); ?>
        <p>휴대폰 : <?php echo get_view_thumbnail($view['wr_4']); ?>
        <p>전화 : <?php echo get_view_thumbnail($view['wr_5']); ?>
        <p>FAX : <?php echo get_view_thumbnail($view['wr_6']); ?>
        <p>소속 : <?php echo get_view_thumbnail($view['wr_7']); ?>
        </p>
