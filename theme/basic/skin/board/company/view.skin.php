    ...
    <section id="bo_v_info">
	    ...
	    <div id="bo_v_top">
	        ...
	        <ul class="btn_bo_user bo_v_com">
	            ...
	            <?php if ($update_href) { ?><li><a href="<?php echo $update_href ?>" class="btn_b01 btn" title="수정"><i class="fa fa-pencil-square-o" aria-hidden="true"></i><span class="sound_only">수정</span></a></li><?php } ?>
...
;
    ...
    <section id="bo_v_atc">
        ...
        <!-- 본문 내용 시작 { -->
        <p>지역 : <?php echo get_view_thumbnail($view['wr_1']); ?>
        <p>단지명 : <?php echo get_view_thumbnail($view['wr_2']); ?>
        <p>업체명 : <?php echo get_view_thumbnail($view['subject']); ?>
        <p>대표자 : <?php echo get_view_thumbnail($view['wr_3']); ?>
        <p>우편번호 : <?php echo get_view_thumbnail($view['wr_4']); ?>
        <p>소재지 : <?php echo get_view_thumbnail($view['wr_5']); ?>
        <p>주생산품 : <?php echo get_view_thumbnail($view['wr_6']); ?>
        <p>전화번호 : <?php echo get_view_thumbnail($view['wr_7']); ?>
        <p>종업원수 : <?php echo get_view_thumbnail($view['wr_8']); ?>
        <p>비고 : <?php echo get_view_thumbnail($view['wr_9']); ?>
        <p>회사소개 : <?php echo get_view_thumbnail($view['wr_content']); ?>
        </p>
