...
<section id="bo_w">
    ...
    <div class="bo_w_tit write_div">
        ...
        <div id="autosave_wrapper" class="write_div">
            ...
            <label for="wr_subject">단지수</label>
            <input type="text" name="wr_2" value="<?php echo $wr_2 ?>" id="wr_subject" required class="frm_input full_input required" size="50" maxlength="255" placeholder="단지수">
            <label for="wr_subject">기업수</label>
            <input type="text" name="wr_3" value="<?php echo $wr_3 ?>" id="wr_subject" required class="frm_input full_input required" size="50" maxlength="255" placeholder="기업수">
            <label for="wr_subject">종업원수</label>
            <input type="text" name="wr_4" value="<?php echo $wr_4 ?>" id="wr_subject" required class="frm_input full_input required" size="50" maxlength="255" placeholder="종업원수">
            <!-- <label for="wr_subject">날짜</label> -->
            <!-- <input type="text" name="wr_6" value="<?php echo $wr_6 ?>" id="wr_subject" required class="frm_input full_input required" size="50" maxlength="255" placeholder="날짜"> -->
